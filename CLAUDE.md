...
- **Migrations:** golang-migrate pairs **0001–0062** in `backend/migrations/` (latest `0062_credentials.*`; go **1.25.0**). Never edit an applied migration — add a new pair.
